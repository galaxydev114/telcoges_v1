@extends('template.main', ['activePage' => 'products', 'titlePage' => __('Editar producto')])
  ...
  <form class="form" method="POST" action="{{ route('products.update', ['productID' => $product->id]) }}">
    ...
    <div class="bmd-form-group{{ $errors->has('code') ? ' has-danger' : '' }}">
      <div class="input-group">
        ...
        <input type="text" name="code" id="code" class="form-control" placeholder="{{ __('Código...') }}" value="{{ $product->code }}">
      </div>
      @if ($errors->has('code'))
    ...
    <div class="bmd-form-group{{ $errors->has('name') ? ' has-danger' : '' }} mt-3">
      <div class="input-group">
        ...
        <input type="text" name="name" class="form-control" placeholder="{{ __('Nombre del producto...') }}" value="{{ $product->name }}" required>
      </div>
      @if ($errors->has('name'))
    ...
    <div class="bmd-form-group{{ $errors->has('description') ? ' has-danger' : '' }} mt-3">
      <div class="input-group">
        ...
        <input type="text" name="description" class="form-control" placeholder="{{ __('Descripción del producto...') }}" value="{{ $product->description }}" required>
      </div>
    ...
    <div class="bmd-form-group{{ $errors->has('price') ? ' has-danger' : '' }} mt-3">
      <div class="input-group">
        ...
        <input type="number" step="0.01" name="price" id="price" class="form-control" placeholder="{{ __('Precio...') }}" value="{{ $product->price }}" required>
      </div>
      @if ($errors->has('price'))
    ...
    <div class="bmd-form-group{{ $errors->has('cost') ? ' has-danger' : '' }} mt-3">
      <div class="input-group">
        ...
        <input type="number" step="0.01" name="cost" id="cost" class="form-control" value="{{ $product->cost }}" required>
      </div>
      @if ($errors->has('cost'))
    ...
    <div class="bmd-form-group{{ $errors->has('cost_tax_rate') ? ' has-danger' : '' }} mt-3">
      <div class="input-group">
        ...
        <input type="number" step="0.01" name="cost_tax_rate" id="cost_tax_rate" class="form-control" value="{{ $product->cost_tax_rate * 100 }}" required>
      </div>
    ...
    <div class="card">
      ...
      <div class="card-body product-items">
        @forelse ($product->productStock()->get() as $item)
          <div class="form-row">
            ...
            <div class="col bmd-form-group{{ $errors->has('serie') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input oninput="this.value = this.value.toUpperCase()" type="text" name="serie[]" id="serie1" class="form-control" placeholder="{{ __('Serie...') }}" value="{{ $item->serie }}">
              </div>
              @if ($errors->has('serie'))
            ...
            <div class="col bmd-form-group{{ $errors->has('provider') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="text" name="provider[]" whorow="1" id="provider1" class="form-control provider-autocomplete" placeholder="{{ __('Proveedor...') }}" autocomplete="off" value="{{ $item->provider }}">
              </div>
